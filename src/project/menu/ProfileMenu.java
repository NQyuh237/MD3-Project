                ...
                while (true) {
                    ...
                    switch (menuUser) {
                        ...
                        case 6:
                            new UserView().logout();
                        default:
                            System.out.println("  Chỉ có " + ColorConfig.RED + "1 " + ColorConfig.RESET + "----> " + ColorConfig.RED + "5 " + ColorConfig.RESET + " Quý khách vui lòng chọn lại !!!\uD83D\uDE22\uD83D\uDE22\uD83D\uDE22");
                    }
                }
            }
        }
